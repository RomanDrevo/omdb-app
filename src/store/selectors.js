...
export const getSelectedMovieDetails = state => state && state.movies && state.movies.selectedMovie;
export const getLoadingStatus = state => state && state.movies && state.movies.loading;
export const getShowFullDescriptionStatus = state => state && state.movies && state.movies.showFullDescription;
export const getShowMovieDetailsStatus = state => state && state.movies && state.movies.showMovieDetails;
